...
> A curated list of the tools, frameworks, and resources every software developer should know — handpicked by the team at [2Coders Studio](https://2coders.com). Pull requests are welcome! See [Contributing](#contributing) for details.
